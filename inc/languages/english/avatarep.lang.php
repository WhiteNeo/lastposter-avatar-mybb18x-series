...
/**
*  Language English
*  Last Poster Avatar on Threads and Forums v 2.9.2
*
...
$l['avatarep_user_alt_forums'] = "Last poster: {1}";
$l['avatarep_user_alt_thread_first'] = "Firts post by: {1}";
$l['avatarep_user_alt_thread_last'] = "Last post by: {1}";
$l['avatarep_user_alt_thread_contributor'] = "Thread Contributor: {1}";
