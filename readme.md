...
<td class="trow1" align="center"> #pmuid_ <avatareplt_start[{$readmessage['pmid']}]><avatarep[{$readmessage['toid']}]['avatar']><avatareplt_end[{$readmessage['pmid']}]>{$readmessage['profilelink']}#</td>
...
<td class="trow1" align="center"> #pmuid_ <avatareplt_start[{$unreadmessage['pmid']}]><avatarep[{$unreadmessage['toid']}]['avatar']><avatareplt_end[{$unreadmessage['pmid']}]>{$unreadmessage['profilelink']}#</td>
